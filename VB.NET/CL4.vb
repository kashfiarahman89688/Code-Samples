...
Public Class CL4
    ...
    Public Sub CL4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        GroupBoxDetails.Enabled = False
        'TODO: This line of code loads data into the 'DataSet4.VW_CL4' table. You can move, or remove it, as needed.
        'Me.VW_CL4TableAdapter.Fill(Me.DataSet4.VW_CL4)
        ...
        Me.VW_CL4TableAdapter.SelectCommand.CommandText = GetParam("fillcl4")
        Me.VW_CL4TableAdapter.Fill(DataSet4.VW_CL4, BranchCode, "%_____________", "%")
    ...
    Private Sub TextBoxAcno_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxAcno.TextChanged
        ...
        Me.VW_CL4TableAdapter.SelectCommand.CommandText = GetParam("fillcl4")
        Me.VW_CL4TableAdapter.Fill(DataSet4.VW_CL4, BranchCode, acct, "%" + TextBoxacname.Text + "%")
    End Sub
    ...
    Private Sub TextBoxacname_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxacname.TextChanged
        ...
        Me.VW_CL4TableAdapter.SelectCommand.CommandText = GetParam("fillcl4")
        Me.VW_CL4TableAdapter.Fill(DataSet4.VW_CL4, BranchCode, "%" + TextBoxAcno.Text.PadRight(13, "_"), acct)
    End Sub

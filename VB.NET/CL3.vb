...
Public Class CL3
    ...
    Public Sub CL3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.VW_CL3TableAdapter.SelectCommand.CommandText = GetParam("fillcl3")
        Me.VW_CL3TableAdapter.Fill(DataSetCL3.VW_CL3, BranchCode, "%_____________", "%")
        ...
        Try
            ...
            If MsgBoxResult.Yes = MsgBoxResult.Yes Or rssql.Fields("MARK").Value.ToString.Trim = "N" Then
                ...
                If rs.State = 1 Then
                    rs.Close()
                End If
                Sql = "select remarks,nvl(basis,'N/A') as basis,(select short from cl_sta where sta = lpad(final_sta,2,'0')) as final_sta,nvl(base_of_provision,'0.00') as base_of_provision,(select short from cl_sta where sta = ob_sta) as ob_sta from cl_clmaster where entry_sta = '00' and" & _
                ...
                txtReschAmt.Text = FormatNumber(DataGridViewCL3.SelectedRows(0).Cells(13).Value.ToString, 2, TriState.True, TriState.False, TriState.False).ToString
                txtIntSus.Text = FormatNumber(DataGridViewCL3.SelectedRows(0).Cells(18).Value.ToString, 2, TriState.True, TriState.False, TriState.False).ToString
                txtEligSec.Text = FormatNumber(DataGridViewCL3.SelectedRows(0).Cells(20).Value.ToString, 0, TriState.True, TriState.False, TriState.False).ToString

                date_format(DataGridViewCL3.SelectedRows(0).Cells(11).Value.ToString)
                TextBoxday.Text = day
...
"SELECT MAX(sta) FROM cl_objcri WHERE d_m_flag3 = '" & dm_flag & "' AND cl3 <= '" & period & "')", conn, ADODB.CursorTypeEnum.adOpenKeyset)
    ...
    Private Sub TextBoxAcno_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxAcno.TextChanged
        ...
        Me.VW_CL3TableAdapter.SelectCommand.CommandText = GetParam("fillcl3")
        Me.VW_CL3TableAdapter.Fill(DataSetCL3.VW_CL3, BranchCode, acct, "%" + TextBoxacname.Text + "%")
    End Sub
    ...
    Private Sub TextBoxacname_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxacname.TextChanged
        ...
        Me.VW_CL3TableAdapter.SelectCommand.CommandText = GetParam("fillcl3")
        Me.VW_CL3TableAdapter.Fill(DataSetCL3.VW_CL3, BranchCode, "%" + TextBoxAcno.Text.PadRight(13, "_"), acct)
    End Sub
    ...
    Private Sub ButtonSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        Try
            ...
            If Trim(TextBoxyear.Text) + Trim(TextBoxmon.Text) + Trim(TextBoxday.Text) > DataGridViewCL3.SelectedRows(0).Cells(5).Value.ToString Then
                MessageBox.Show("Date should be less than Reference Date.")
                TextBoxyear.Text = ""
                TextBoxmon.Text = ""
                TextBoxday.Text = ""
                TextBoxday.Focus()

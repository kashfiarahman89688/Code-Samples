...
Public Class CL6
    ...
    Public Sub CL6_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DataSet6.VW_CL6' table. You can move, or remove it, as needed.
        ...
        Me.VW_CL6TableAdapter.SelectCommand.CommandText = GetParam("fillcl6")
        Me.VW_CL6TableAdapter.Fill(DataSet6.VW_CL6, BranchCode, "%_____________", "%")
    ...
    Private Sub DataGridViewCL3_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGridViewCL3.DoubleClick
        Try
            ...
            If MsgBoxResult.Yes = MsgBoxResult.Yes Or rssql.Fields("MARK").Value.ToString.Trim = "N" Then
                ...
                'txtArrear.Text = ar + " Month/s"
                Sql = GetParam("oc_stacl6")
                If rssql.State = 1 Then
                    rssql.Close()
                End If
    ...
    Private Sub TextBoxAcno_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxAcno.TextChanged
        ...
        Me.VW_CL6TableAdapter.SelectCommand.CommandText = GetParam("fillcl6")
        Me.VW_CL6TableAdapter.Fill(DataSet6.VW_CL6, BranchCode, acct, "%" + TextBoxacname.Text + "%")
    End Sub
    ...
    Private Sub TextBoxacname_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxacname.TextChanged
        ...
        Me.VW_CL6TableAdapter.SelectCommand.CommandText = GetParam("fillcl6")
        Me.VW_CL6TableAdapter.Fill(DataSet6.VW_CL6, BranchCode, "%" + TextBoxAcno.Text.PadRight(13, "_"), acct)
    End Sub
